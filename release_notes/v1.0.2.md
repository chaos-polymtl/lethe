...
A new feature which allows users to apply a single boundary condition to multiple boundary conditions id, greatly simplifying parameter files.
...
The lethe v1.0.2 release comes with a structured and stable syntax. All of the examples and tests provided with lethe were re-ran with this v1.0.2 release to ensure that all of the results provided online are up to date. This version is production-ready and has been tested and validated extensively.
