...
public:
  MMSUnstructuredNavierStokes(NavierStokesSolverParameters<dim> nsparam,
...
template <int dim> void MMSUnstructuredNavierStokes<dim>::runMMSUnstructured() {
...
int main(int argc, char *argv[]) {
  try {
    ...
    MMSUnstructuredNavierStokes<2> problem_2d(
