...
template <int dim> class ExactInitialSolution : public Function<dim> {
public:
...
template <int dim> void InitialConditionsNavierStokes<dim>::run() {
  this->read_mesh();
  this->setup_dofs();
...
template <int dim> void InitialConditionsNavierStokes<dim>::runTest() {
