...
template <int dim> class ConstantXForce : public Function<dim> {
public:
...
template <int dim> class ExactSolutionPoiseuille : public Function<dim> {
public:
...
public:
  PeriodicPoiseuille(NavierStokesSolverParameters<dim> nsparam,
...
template <int dim> void PeriodicPoiseuille<dim>::run() {
  this->read_mesh();
  this->setup_dofs();
...
int main(int argc, char *argv[]) {
  try {
    ...
    PeriodicPoiseuille<2> problem_2d(nsparam,
