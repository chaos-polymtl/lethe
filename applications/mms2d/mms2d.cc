...
template <int dim> class MMSNavierStokes : public GLSNavierStokesSolver<dim> {
public:
  MMSNavierStokes(NavierStokesSolverParameters<dim> nsparam,
...
template <int dim> void MMSNavierStokes<dim>::run() {
...
int main(int argc, char *argv[]) {
  try {
    ...
    MMSNavierStokes<2> problem_2d(NSparam, NSparam.femParameters.velocityOrder,
