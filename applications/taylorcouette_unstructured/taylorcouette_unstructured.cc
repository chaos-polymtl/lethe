...
template <int dim> class ExactSolutionTaylorCouette : public Function<dim> {
public:
...
template <int dim>
void ExactSolutionTaylorCouette<dim>::vector_value(
...
template <int dim> void TaylorCouetteNavierStokes<dim>::run() {
...
int main(int argc, char *argv[]) {
  try {
    ...
    TaylorCouetteNavierStokes<2> problem_2d(
        NSparam, NSparam.femParameters.velocityOrder,
