...
public:
  ...
  /**
   * @brief Compute the Kelly error estimator on the tracer variable for mesh refinement.
   * See :
  ...
  /**
   * @brief Prepares Tracer physics to write checkpoint
   */
  void
  ...
  {
    return simulation_parameters.linear_solver.at(PhysicsID::tracer)
