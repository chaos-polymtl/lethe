...
// TODO AA erase
template <int dim>
class VOFAssemblerDiffusionTest : public VOFAssemblerBase<dim>
{
public:
  VOFAssemblerDiffusionTest()
  {}
  /**
   * @brief Assemble the matrix
   *
...
// TODO AA erase
template <int dim>
class VOFAssemblerAdvectionTest : public VOFAssemblerBase<dim>
{
public:
  VOFAssemblerAdvectionTest()
  {}
  /**
   * @brief Assemble the matrix
   *
