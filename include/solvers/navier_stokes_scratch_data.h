      ...
      for (auto &particle : pic)
        {
          ...
          for (int d = 0; d < dim; ++d)
            {
              particle_properties[DEM::PropertiesIndex<DEM::SolverType::cfd_dem>::fem_force_x + d]  = 0.;
              particle_properties[DEM::PropertiesIndex<DEM::SolverType::cfd_dem>::fem_torque_x + d] = 0.;
