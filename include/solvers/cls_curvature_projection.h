...
#ifndef lethe_cls_curvature_projection_h
#define lethe_cls_curvature_projection_h
...
/**
 * @brief CLS curvature L2 projection solver.
 *
 * @tparam dim Number of dimensions of the problem.
 */
template <int dim>
class CLSCurvatureProjection : public CLSLinearSubequationsSolver<dim>
{
public:
  /**
   * @brief Constructor for the L2 projection of the CLS interface curvature.
   *
   ...
   */
  ~CLSCurvatureProjection() = default;
