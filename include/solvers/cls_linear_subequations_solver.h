...
/**
 * @brief Generalized solver for CLS linear subequations.
 *
 ...
 */
template <int dim>
class CLSLinearSubequationsSolver : public PhysicsLinearSubequationsSolver
{
public:
  /**
   * @brief Constructor for linear subequations solvers within the CLS
   * auxiliary physics
   *
   ...
   * current one.
   */
  CLSLinearSubequationsSolver(
    const CLSSubequationsID         &p_subequation_id,
    ...
    , linear_solver_verbosity(
        p_simulation_parameters.linear_solver.at(PhysicsID::CLS).verbosity)
   ...
   */
  virtual ~CLSLinearSubequationsSolver() = default;
...
protected:
  ...
  const CLSSubequationsID        subequation_id;
  CLSSubequationsInterface<dim> &subequations_interface;
