...
#ifndef lethe_navier_stokes_cls_assemblers_h
#define lethe_navier_stokes_cls_assemblers_h
 ...
 */
template <int dim>
class GLSNavierStokesCLSAssemblerCore : public NavierStokesAssemblerBase<dim>
{
public:
  GLSNavierStokesCLSAssemblerCore(
 ...
 * free surface using CLS modeling. For example, if a BDF1 scheme is
 ...
 */
template <int dim>
class GLSNavierStokesCLSAssemblerBDF : public NavierStokesAssemblerBase<dim>
{
public:
  GLSNavierStokesCLSAssemblerBDF(
    const std::shared_ptr<SimulationControl> &simulation_control)
    : simulation_control(simulation_control)
  {}
...
/**
 * @brief Assembles a phase change Darcy forcing term for a CLS two-fluid
 ...
 */
template <int dim>
class PhaseChangeDarcyCLSAssembler : public NavierStokesAssemblerBase<dim>
{
public:
...
public:
  ...
  PhaseChangeCarmanKozenyCLSAssembler(
    const double                                carman_kozeny_permeability_area,
 ...
 */
template <int dim>
class GLSNavierStokesCLSAssemblerSTF : public NavierStokesAssemblerBase<dim>
{
public:
  GLSNavierStokesCLSAssemblerSTF(
    const std::shared_ptr<SimulationControl> &p_simulation_control,
    const SimulationParameters<dim>          &nsparam)
    : simulation_control(p_simulation_control)
    , STF_parameters(nsparam.multiphysics.cls_parameters.surface_tension_force)
  {}
  ...
  const Parameters::CLS_SurfaceTensionForce STF_parameters;
};
 ...
 */
template <int dim>
class GLSNavierStokesCLSAssemblerMarangoni
  : public NavierStokesAssemblerBase<dim>
{
public:
  GLSNavierStokesCLSAssemblerMarangoni(
    const std::shared_ptr<SimulationControl> &p_simulation_control,
    Parameters::CLS_SurfaceTensionForce       p_STF_properties)
    : simulation_control(p_simulation_control)
  ...
  // Surface tension force (STF)
  const Parameters::CLS_SurfaceTensionForce STF_properties;
};
 ...
 */
template <int dim>
class NavierStokesCLSAssemblerEvaporation
  : public NavierStokesAssemblerBase<dim>
{
public:
  NavierStokesCLSAssemblerEvaporation(
    const std::shared_ptr<SimulationControl> &p_simulation_control,
...
{
public:
  GLSNavierStokesCLSAssemblerNonNewtonianCore(
    const std::shared_ptr<SimulationControl> &simulation_control,
    const SimulationParameters<dim>          &nsparam)
    : simulation_control(simulation_control)
    , cls_parameters(nsparam.multiphysics.cls_parameters)
...
/**
 * @brief Assembles the thermal buoyancy source term for CLS simulations.
 * This assembler includes density explicitly in the buoyancy term since
 * the CLS momentum equation is written as:
 ...
 */
template <int dim>
class ThermalBuoyancyAssemblyCLS : public NavierStokesAssemblerBase<dim>
{
public:
  ThermalBuoyancyAssemblyCLS(
    const std::shared_ptr<SimulationControl> &simulation_control,
