...
protected:
  ...
  // A scalar function that doesn't require solving, just evaluation. This attribute is currently only used for representing an object shape (using the sharp interface fem-dem)
