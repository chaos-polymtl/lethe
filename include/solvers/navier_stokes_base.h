...
protected:
  ...
  /**
   * @brief gather_output_results
   * Gather solution information to generate output results
   */
  void
   ...
   * Generate post-processing parallel VTU files from vector of
   * solution_output_struct
   */
  void
  write_output_results() const;
