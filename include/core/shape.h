...
public:
  ...
  set_orientation(const Tensor<1, 3> &new_orientation)
  {
     ...
     *
     */
    inline virtual Point<dim> get_position()
    {
      return position;
    }
     ...
     *
     */
    inline virtual Tensor<1, 3> get_orientation()
    {
      return orientation;
    }
     ...
     *
     */
    inline virtual Tensor<2, 3> get_rotation_matrix()
    {
     ...
     * @return The aligned and centered point
     */
    void update_ration_matrix(const Point<dim> &evaluation_point) const;
     ...
     * @return The aligned and centered point
     */
    Point<dim> reverse_align_and_center(const Point<dim> &evaluation_point)
      const;
     ...
     */
    void set_part_of_a_composite(const bool part_of_a_composite)
    {
     ...
     */
    virtual void set_layer_thickening(const double layer_thickening)
    {
     ...
     * layer of specified width.
     */
    Tensor<1,3>rotation_matrix_to_xyz_angles(Tensor<2,3>& rotation_matrix_representation) const{
