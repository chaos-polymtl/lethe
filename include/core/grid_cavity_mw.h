 ...
 * cylinder so that mesh refinement preserves the  the shape of the fluid
 * chennel.
 *
...
public:
   ...
   * bottom_height : center_height : top_height : shape" @endcode
   *
   ...
   * paving stone), top cylinder) are first merged and returned coarse
   *
