...
public:
  ...
  momentum_flux(const std::map<field, double> &field_values) override
  {
    ...
    // {
    //   std::cout << "expansion_pressure = " << expansion_pressure <<
    //   std::endl; std::cout << "recoil_pressure = " <<
    //   recoil_pressure_coefficient * saturation_pressure_value << std::endl;
    //   std::cout << "std::max(pressure - ambient_pressure, 0.0) = " <<
    //   std::max(pressure - ambient_pressure, 0.0) << std::endl;
    // }
