...
public:
   ...
   * all touching particles. Stock normal forces and particles position in vectors.
   *
 ...
 * by writing vtu files. Instead of using a inheritance hiearchy to distinguish between
...
class ParticlesForceChains
  ...
  public ParticleParticleContactForce<dim, force_model, rolling_friction_model>
{
public:
