...
if has_proj:
  ...
  t_proj, x_proj, y_proj, vx_proj, vy_proj, x_dum, y_dum, z_dum, vx_dum, vy_dum, vz_dum = np.loadtxt(filename_barycenter_proj, skiprows=1, unpack=True)
  n += 1
...
if has_geo:
  ...
  t_geo, x_geo, y_geo, vx_geo, vy_geo, x_dum, y_dum, z_dum, vx_dum, vy_dum, vz_dum = np.loadtxt(filename_barycenter_geo, skiprows=1, unpack=True)
  n += 1
...
if has_alge:
  ...
  t_alge, x_alge, y_alge, vx_alge, vy_alge, x_dum, y_dum, z_dum, vx_dum, vy_dum, vz_dum = np.loadtxt(filename_barycenter_alge, skiprows=1, unpack=True)
  n += 1
