...
USAGE="Usage: $0 [-t <path_to_template_parameter_file>] \n
            ...
            \t[-rd <true/false>] \n
            \n
             -t: Path to template parameter file (default: ./rising-bubble-3d-geo.tpl) \n
             -j: Path to template job file for launching simulations on clusters (default: ./launch.tpl) \n
             -p: Path to CSV file with case parameters (default: ./rising-bubble-3d-cases.csv) \n
...
template_parameter_file="${template_parameter_file:-./rising-bubble-3d.tpl}"
template_job_file="${template_job_file:-./launch.tpl}"
cases_csv_file="${cases_csv_file:-./rising-bubble-3d-cases.csv}"
