...
def printClCd():
    ...
    RefCl = [0, 0.24740532959326786, 0.302945301542777, 0.31977559607293127, 0.3702664796633941, 0.4140252454417952, 0.5570827489481065, 0.6328190743338008, 0.6631136044880784]
    RefCd = [0.1211781206171108, 0.12959326788218792, 0.13800841514726506, 0.14137447405329592, 0.15483870967741933, 0.1649368863955119, 0.2187938288920056, 0.2507713884992987,0.28443197755960725]
    ...
    axis[0].set_title("Evolution of lift coefficient with attack angle on NACA0012 airfoil at Re = 1000")
    axis[0].set_xlabel("Angle of attack (°)")
    axis[0].set_ylabel("RMS value of lift coefficient")
    ...
    axis[1].set_title("Evolution of drag coefficient with attack angle on NACA0012 airfoil at Re = 1000")
    axis[1].set_xlabel("Angle of attack (°)")
    axis[1].set_ylabel("RMS value of drag coefficient")
