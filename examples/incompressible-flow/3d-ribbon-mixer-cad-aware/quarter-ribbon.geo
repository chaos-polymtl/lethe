// SPDX-FileCopyrightText: Copyright (c) 2020 The Lethe Authors
// SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception OR LGPL-2.1-or-later

//SetFactory("OpenCASCADE");
Mesh.CharacteristicLengthMin = 0.0001;
Mesh.CharacteristicLengthMax = 0.050;
...
// Cote
Physical Surface (0) = {101,103:106};
// Haut
Physical Surface (1) = {102};

// Ruban
// Ruban 1
Physical Surface (2) = {1:6};
// Ruban 2
Physical Surface (3) = {10:60};
//Tige
Physical Surface (4) = {3101:3106};
Physical Volume (0) = {2};

Field[1] = Attractor;
//Field[1].FacesList = {1:6,10:60,3101:3106};
Field[1].EdgesList = {21:32,1:12,31011:31014};
Field[1].NodesList = {10000:10060,20000:20060,30000:30060,40000:40060, 1000:1060, 2000:2060,3000:3060,4000:4060};



Field[2] = Threshold;
Field[2].IField = 1;
Field[2].LcMin = l / factor;
Field[2].LcMax = l;
Field[2].DistMin = 0.030;
