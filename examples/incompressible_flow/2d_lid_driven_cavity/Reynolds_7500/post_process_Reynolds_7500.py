...
ref_data_ghia = "../ref_2d_ghia_u.txt"
raw_ghia=np.loadtxt(ref_data_ghia,skiprows=2)
y_ghia=raw_ghia[:,0]
u_ghia=raw_ghia[:,6]

ref_data_erturk = "../ref_2d_erturk_u.txt"
...
plt.ylabel("y")
plt.legend()
plt.savefig("lethe_ghia_re_7500_comparison.png", dpi=300)
plt.show()
...
plt.ylim([0.9,1])
plt.legend()
plt.savefig("lethe_ghia_re_7500_comparison_zoom.png", dpi=300)
plt.show()
