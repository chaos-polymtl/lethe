...
------------------------
- Base case (:math:`R_e=400`) : ``/examples/incompressible_flows/cavity.prm``
- Re=7500 : ``/examples/incompressible_flows/Reynolds_7500/cavity.prm``
...
Only the upper wall boundary moves in the x direction with a constant velocity (u = 1 m/s) while the other boundaries are static. We will discuss later in this example the meaning of the ID of the boundary conditions used in this figure.
