...
As for the pressure, it converges at the second-order for the shape functions pairs :math:`\in \{Q_1-Q_1, Q_2-Q_1, Q_2-Q_2\}` and :math:`\in \{P_1-P_1, P_2-P_1, P_2-P_2\}`, and to the third-order for combinations :math:`\in \{Q_3-Q_2, Q_3-Q_3, P_3-P_2, P_3-P_3\}`. 
