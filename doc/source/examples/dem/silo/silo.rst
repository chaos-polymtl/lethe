...
- GMSH geo file: ``examples/dem/3d-silo/silo-Golshan.geo``
...
The floating wall is a temporary (its start and end times are defined) flat wall, generally used for holding the particles during the filling of particles within the simulation domain.
