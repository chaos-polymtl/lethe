...
We first introduce the different sections of the parameter file ``dem_packing_in_fluidized_bed.prm`` needed to run this simulation. 
...
.. code-block:: text
  ...
  dem_3d dem_packing_in_fluidized_bed.prm
...
.. code-block:: text
    ...
    path_to_cfd_dem_application/cfd_dem_coupling_3d fluidized_bed.prm 
