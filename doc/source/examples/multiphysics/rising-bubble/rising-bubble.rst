...
------------------------
``examples/multiphysics/rising-bubble/rising-bubble.prm``
...
To capture the bubble adequately, we set ``initial refinement steps = 3`` so that the initial mesh is adapted to the initial condition.
