...
List
--------------------
The ``list`` insertion method insert particles at precise coordinates with specific velocities (translational and angular) and diameters.  This method is preferred for small number of particles.
