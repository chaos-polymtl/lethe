...
.. code-block:: text
   ...
   subsection cfd-dem
      ...
      set interpolated void fraction = false
      set drag force = true
...
* The ``interpolated void fraction`` parameter allows us choose whether the void fraction used to calculate drag is the cell void fraction or the one interpolated at the position of the particle.
