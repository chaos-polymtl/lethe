...
* The ``tracer reaction constant outside`` and ``tracer reaction constant outside`` parameters represents the desired reaction constant inside and outside of the solid.
