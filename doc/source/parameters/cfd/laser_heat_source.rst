...
The exponential decaying model [2] is used to simulate the haser heat souce. In the exponential decaying model, the laser heat flux is calculated using the following equation:
