  ...
  dealii::ParameterHandler &prm)
{
  prm.enter_subsection("algebraic interface reinitialization");
  {
    ...
    // TODO AA Erase
    prm.declare_entry("enable linear solving",
                      "false",
                      Patterns::Bool(),
                      "Enables solving the linearized version of the equation"
                      "<true|false>");
    prm.declare_entry("compute time-step with cfl",
                      "false",
                      Patterns::Bool(),
                      "Compute time-step as a ratio with the velocity"
                      "<true|false>");
  }
  prm.leave_subsection();
}
  ...
  dealii::ParameterHandler &prm)
{
  prm.enter_subsection("algebraic interface reinitialization");
  {
    ...
    // TODO AA Erase
    enable_linear_solving      = prm.get_bool("enable linear solving");
    compute_time_step_with_cfl = prm.get_bool("compute time-step with cfl");
  }
  prm.leave_subsection();
}
