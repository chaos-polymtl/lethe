...
{
  if (control.getMethod() == Parameters::SimulationControl::TimeSteppingMethod::steady)
    {
      pcout << std::endl;
      pcout
        << "*****************************************************************"
...
{
  if ((parameterControl.method == Parameters::SimulationControl::TimeSteppingMethod::steady &&
       iter >= (nbMeshAdapt + 1)) ||
      (parameterControl.method != Parameters::SimulationControl::TimeSteppingMethod::steady &&
