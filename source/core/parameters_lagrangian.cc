...
void SimulationControl::declare_parameters(ParameterHandler &prm) {
  prm.enter_subsection("simulation control");
  {
    ...
    prm.declare_entry("n total", "1", Patterns::Integer(),
                      "Total number of particles");
    prm.declare_entry("write frequency", "1", Patterns::Integer(),
                      "Write frequency");
  }
...
void PhysicalProperties::declare_parameters(ParameterHandler &prm) {
  ...
  {
    prm.declare_entry("gx", "1.", Patterns::Double(),
                      "Gravitational acceleration in x direction");
    prm.declare_entry("gy", "1.", Patterns::Double(),
                      "Gravitational acceleration in y direction");
    prm.declare_entry("gz", "1.", Patterns::Double(),
                      "Gravitational acceleration in z direction");
    prm.declare_entry("diameter", "1.", Patterns::Double(),
                      "Particle diameter");
    prm.declare_entry("density", "1.", Patterns::Double(), "Particle density");
    prm.declare_entry("Youngs_modulus_particle", "1.", Patterns::Double(),
                      "Young's modulus of particle");
    prm.declare_entry("Youngs_modulus_wall", "1.", Patterns::Double(),
                      "Young's modulus of wall");
    prm.declare_entry("Poisson_ratio_particle", "1.", Patterns::Double(),
                      "Poisson's ratio of particle");
    prm.declare_entry("Poisson_ratio_wall", "1.", Patterns::Double(),
                      "Poisson's ratio of wall");
    prm.declare_entry("restitution_coefficient_particle", "1.",
                      Patterns::Double(),
                      "Coefficient of restitution of particle");
    prm.declare_entry("restitution_coefficient_wall", "1.", Patterns::Double(),
                      "Coefficient of restitution of wall");
    prm.declare_entry("friction_coefficient_particle", "1.", Patterns::Double(),
                      "Friction coefficient of particle");
    prm.declare_entry("friction_coefficient_wall", "1.", Patterns::Double(),
                      "Friction coefficient of wall");
    prm.declare_entry("rolling_friction_particle", "1.", Patterns::Double(),
                      "Rolling friction coefficient of particle");
    prm.declare_entry("rolling_friction_wall", "1.", Patterns::Double(),
...
void InsertionInfo::declare_parameters(ParameterHandler &prm) {
  ...
  {
    prm.declare_entry("Insertion time step", "1", Patterns::Integer(),
                      "Insertion time steps");
    prm.declare_entry("Inserted number of particles at each time step", "1",
                      Patterns::Integer(),
                      "Inserted number of particles at each time step");
    prm.declare_entry("Insertion frequency", "1", Patterns::Integer(),
                      "Insertion frequncy");
    prm.declare_entry("Insertion box minimum x", "1", Patterns::Double(),
                      "Insertion x min");
    prm.declare_entry("Insertion box minimum y", "1", Patterns::Double(),
                      "Insertion y min");
    prm.declare_entry("Insertion box minimum z", "1", Patterns::Double(),
                      "Insertion z min");
    prm.declare_entry("Insertion box maximum x", "1", Patterns::Double(),
                      "Insertion x max");
    prm.declare_entry("Insertion box maximum y", "1", Patterns::Double(),
                      "Insertion y max");
    prm.declare_entry("Insertion box maximum z", "1", Patterns::Double(),
                      "Insertion z max");
    prm.declare_entry("Insertion distance threshold", "1", Patterns::Double(),
                      "Distance threshold");
    prm.declare_entry("Insertion random number range", "1", Patterns::Double(),
                      "Random number range");
    prm.declare_entry("Insertion random number seed", "1", Patterns::Integer(),
                      "Random number seed");
  }
  prm.leave_subsection();
}
...
void OutputProperties::declare_parameters(ParameterHandler &prm) {
  ...
  {
    prm.declare_entry("Number of properties", "1", Patterns::Integer(),
                      "Number of properties for visualization");

    prm.declare_entry("Output directory", "1", Patterns::FileName(),
                      "Visulization output folder");

    prm.declare_entry("General information file prefix", "1",
                      Patterns::FileName(),
                      "General information file (.pvtu) prefix");

    prm.declare_entry("Result name prefix", "1", Patterns::FileName(),
...
void ModelParameters::declare_parameters(ParameterHandler &prm) {
  prm.enter_subsection("model parameters");
  {
    prm.declare_entry("pp_broad_search_frequency", "1", Patterns::Integer(),
                      "Particle-particle broad search frequency");

    prm.declare_entry("pw_broad_search_frequency", "1", Patterns::Integer(),
                      "Particle-wall broad search frequency");

    prm.declare_entry("print_info_frequency", "1", Patterns::Integer(),
                      "Print simulation info frequency");

    prm.declare_entry("pp_contact_force_method", "pp_nonlinear",
...
void ModelParameters::parse_parameters(ParameterHandler &prm) {
  prm.enter_subsection("model parameters");
  {
    pp_broad_search_frequency = prm.get_integer("pp_broad_search_frequency");
    pw_broad_search_frequency = prm.get_integer("pw_broad_search_frequency");
