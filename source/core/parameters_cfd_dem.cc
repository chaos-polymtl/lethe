...
namespace Parameters
{
  ...
  VoidFractionParameters<dim>::declare_parameters(ParameterHandler &prm)
  {
    ...
    template <int dim>
    void VoidFractionParameters<dim>::parse_parameters(ParameterHandler & prm)
    {
      prm.enter_subsection("void fraction");
      ...
      particle_refinement_factor =
        prm.get_integer("particle refinement factor");
      qcm_sphere_diameter = prm.get_double("qcm sphere diameter");
      qcm_sphere_equal_cell_volume =
        prm.get_bool("qcm sphere equal cell volume");
    ...
    void CFDDEM::declare_parameters(ParameterHandler & prm)
    {
    ...
    void CFDDEM::parse_parameters(ParameterHandler & prm)
    {
      prm.enter_subsection("cfd-dem");
