  ...
  const typename DoFHandler<dim>::active_cell_iterator &cell)
{
  ...
  // initial cell, if using a map generated by 
  // LetheGridTools::vertices_cell_mapping. This is not the case for maps
  // generated by LetheGridTools::vertices_cell_mapping_with_periodic_boundaries
