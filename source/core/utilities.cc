...
find_cell_around_point_with_tree(const DoFHandler<3> & dof_handler,Point<3> point);
template typename DoFHandler<2>::active_cell_iterator
find_cell_around_point_with_tree(const DoFHandler<2> & dof_handler,Point<2> point);
