...
template
TableHandler make_table_from_vector_of_tensors(std::vector<Tensor<1, 2>> vector,
                                               std::vector<std::string> column_names,
                                               const unsigned int display_precision);

template
TableHandler make_table_from_vector_of_tensors(std::vector<Tensor<1, 3>> vector,
                                               std::vector<std::string> column_names,
                                               const unsigned int display_precision);
