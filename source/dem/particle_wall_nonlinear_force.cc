...
template <int dim, DEM::SolverType solver_type>
void
ParticleWallNonLinearForce<dim,solver_type>::calculate_particle_wall_contact_force(
...
template <int dim, DEM::SolverType solver_type>
void
ParticleWallNonLinearForce<dim,solver_type>::calculate_particle_floating_wall_contact_force(
...
template <int dim, DEM::SolverType solver_type>
std::tuple<Tensor<1, 3>, Tensor<1, 3>, Tensor<1, 3>, Tensor<1, 3>>
ParticleWallNonLinearForce<dim,solver_type>::calculate_nonlinear_contact_force_and_torque(
