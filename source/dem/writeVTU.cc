...
void WriteVTU::write_master_files(const Visualization &data_out,
...
void WriteVTU::writeVTUFiles(int DEM_step, float DEM_time,
                             Visualization data_out) {

  // const unsigned int n_processes =
  // Utilities::MPI::n_mpi_processes(this->get_mpi_communicator()); const
  // unsigned int n_processes = 1;

  std::ofstream filename(
      ("particles/" + Utilities::int_to_string(DEM_step, 4) + ".vtu"));
  ...
  // There is a if definition for variable group_files in particle.cc, here I
  // used 1 temporarily:
  // int group_files = 1;
