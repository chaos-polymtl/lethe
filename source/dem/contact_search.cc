...

{
  ...
  for (typename Triangulation<dim>::active_cell_iterator cell =
    ...
    for (auto cellIt = cellNeighborList[cell_number_iterator].begin();
         cellIt != cellNeighborList[cell_number_iterator].end(); cellIt++) {
      ...
      for (typename Particles::ParticleHandler<
        ...
        if (cellIt == cellNeighborList[cell_number_iterator].begin()) {
          typename Particles::ParticleHandler<
