...
void DEM_iterator<dim, spacedim>::engine(
    ...
    int tInsertion, int inserted_number_at_step, int insertFrequency,
    double distance_threshold, float x_min, float y_min, float z_min,
    float x_max, float y_max, float z_max, int numFields, int numProperties) {
  // moving walls
