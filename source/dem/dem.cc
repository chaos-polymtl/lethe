  ...
  while (DEM_step < number_of_steps)
    {
      ...
      // REFACTORING
      // Why is this a floating point modulu? Should be a regular modulo for integers...
      // It would be better if the insertion class would control these elements
      // You could have a mother class for insertion and derive from there the type of insertion
