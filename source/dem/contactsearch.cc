		...
		for (unsigned int i = 0; i < contactInfo.size(); i++)
		{
			...
			distance = ((std::get<0>(contactInfo[i]).first->get_properties()[2] + std::get<0>(contactInfo[i]).first->get_properties()[2])/2) - v1.distance(v2);
				if(distance > 0)
				{
					...
					std::vector<double> normVec = normVector({std::get<0>(contactInfo[i]).second->get_properties()[4] ,std::get<0>(contactInfo[i]).second->get_properties()[5] ,std::get<0>(contactInfo[i]).second->get_properties()[6]} , {std::get<0>(contactInfo[i]).first->get_properties()[4],std::get<0>(contactInfo[i]).first->get_properties()[5],std::get<0>(contactInfo[i]).first->get_properties()[6]});
					std::vector<double> relVel = vecAdd(vecSubtract({std::get<0>(contactInfo[i]).first->get_properties()[7], std::get<0>(contactInfo[i]).first->get_properties()[8], std::get<0>(contactInfo[i]).first->get_properties()[9]} , {std::get<0>(contactInfo[i]).second->get_properties()[7], std::get<0>(contactInfo[i]).second->get_properties()[8], std::get<0>(contactInfo[i]).second->get_properties()[9]}) , (crossProduct(vecAdd(numVecProd(std::get<0>(contactInfo[i]).first->get_properties()[2] ,{std::get<0>(contactInfo[i]).first->get_properties()[16], std::get<0>(contactInfo[i]).first->get_properties()[17], std::get<0>(contactInfo[i]).first->get_properties()[18]} ) , numVecProd( std::get<0>(contactInfo[i]).second->get_properties()[2],{std::get<0>(contactInfo[i]).second->get_properties()[16], std::get<0>(contactInfo[i]).second->get_properties()[17], std::get<0>(contactInfo[i]).second->get_properties()[18]} )) , normVec)));
					...
					infoTuple = std::make_tuple(std::get<0>(contactInfo[i]), relVel, distance, normVec, normRelVel, relTangVel, tangVec, tangRelVel, tangOverlap);
