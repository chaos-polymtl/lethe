      ...
      for (int d = 0; d < dim; ++d)
        {
          ...
          particle_properties[PropertiesIndex::v_x + d] +=
            0.5 * dt *
            (g[d] + (particle_properties[DEM::PropertiesIndex::force_x + d]) /
  ...
  for (auto &particle : particle_handler)
    {
      ...
      // for (int d = 0; d < 3; ++d)
      {
        ...
        particle_properties[PropertiesIndex::omega_x] +=
          particle_properties[DEM::PropertiesIndex::torque_x] * dt_MOI_inverse;
        particle_properties[PropertiesIndex::omega_y] +=
          particle_properties[DEM::PropertiesIndex::torque_y] * dt_MOI_inverse;
        particle_properties[PropertiesIndex::omega_z] +=
          particle_properties[DEM::PropertiesIndex::torque_z] * dt_MOI_inverse;
