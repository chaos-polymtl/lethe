      ...
      for (auto contact_information_iterator =
           ...
           ++contact_information_iterator)
        {
          ...
          double normal_spring_constant =
            1.2024 *
            pow((pow(effective_mass, 0.5) * pow(effective_youngs_modulus, 2.0) *
                 effective_radius *
          ...
          double maximum_tangential_overlap =
            ...
            ((2 - physical_properties.Poisson_ratio_particle) /
          ...
          /*
             ...
             *
             ...
             particle_two_angular_velocity) .norm(); if (omega_value != 0) {
                  // omega_ij =
                  //    (particle_one_angular_velocity -
             ...
             particle_one_angular_velocity) / omega_value;
                ...
                Tensor<1, dim> rolling_resistance_torque =
                    -1.0 *
             physical_properties.rolling_friction_coefficient_particle
