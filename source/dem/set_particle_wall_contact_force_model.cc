  ...
  const parallel::distributed::Triangulation<dim> &triangulation)
{
  ...
  if (dem_parameters.model_parameters.particle_wall_contact_force_method ==
    ...
    {
      particle_wall_contact_force_object =
        std::make_shared<ParticleWallLinearForce<dim,solver_type>>(dem_parameters,
                                                       boundary_index);
    }
    ...
    {
      particle_wall_contact_force_object =
        std::make_shared<ParticleWallNonLinearForce<dim,solver_type>>(dem_parameters,
                                                          boundary_index);
    }
  else if (dem_parameters.model_parameters.particle_wall_contact_force_method ==
           Parameters::Lagrangian::ModelParameters::
    ...
    {
      particle_wall_contact_force_object =
        std::make_shared<ParticleWallJKRForce<dim,solver_type>>(dem_parameters,
                                                    boundary_index);
    }
  else if (dem_parameters.model_parameters.particle_wall_contact_force_method ==
           Parameters::Lagrangian::ModelParameters::
    ...
    {
      particle_wall_contact_force_object =
        std::make_shared<ParticleWallDMTForce<dim,solver_type>>(dem_parameters,
                                                    boundary_index);
    }
  else
    {
