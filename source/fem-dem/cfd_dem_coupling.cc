  ...
  for (auto particle = this->particle_handler.begin();
       ...
       ++particle)
    {
      ...
      force[particle_id][0] += particle_properties
        [DEM::PropertiesIndexEnum<SolverType::cfd_dem>::fem_force_x];
      force[particle_id][1] += particle_properties
        [DEM::PropertiesIndexEnum<SolverType::cfd_dem>::fem_force_y];
      force[particle_id][2] += particle_properties
        [DEM::PropertiesIndexEnum<SolverType::cfd_dem>::fem_force_z];
    }
}
  ...
  for (auto particle = this->particle_handler.begin();
       ...
       ++particle)
    {
      ...
      torque[particle_id][0] += particle_properties
        [DEM::PropertiesIndexEnum<SolverType::cfd_dem>::fem_torque_x];
      torque[particle_id][1] += particle_properties
        [DEM::PropertiesIndexEnum<SolverType::cfd_dem>::fem_torque_y];
      torque[particle_id][2] += particle_properties
        [DEM::PropertiesIndexEnum<SolverType::cfd_dem>::fem_torque_z];
    }
}
          ...
          if (id == i)
            {
              ...
              std::cout
                ...
                << particle_properties
                     [DEM::PropertiesIndexEnum<SolverType::cfd_dem>::v_x]
                << std::setw(display_width) << std::left
                << particle_properties
                     [DEM::PropertiesIndexEnum<SolverType::cfd_dem>::v_y]
                << std::setw(display_width) << std::left
                << particle_properties
                     [DEM::PropertiesIndexEnum<SolverType::cfd_dem>::v_z]
                << std::endl;
            }
        }
      usleep(500);
      ...
      for (auto &particle : this->particle_handler)
        {
          ...
          MOI[particle.get_local_index()] =
            0.1 *
            particle_properties
              [DEM::PropertiesIndexEnum<SolverType::cfd_dem>::mass] *
            particle_properties
              [DEM::PropertiesIndexEnum<SolverType::cfd_dem>::dp] *
            particle_properties
              [DEM::PropertiesIndexEnum<SolverType::cfd_dem>::dp];
        }
    }
