                                                ...
                                                const double mu)
{
  ...
  Tensor<1, 3> gravity;
  std::cout<<"finish vector initialization start particle initialization"<<std::endl;
  ...
  std::cout<<"finish particle initialization start the integration"<<std::endl;
  ...
  while (t + 0.5 * dt_dem < dt)
    {
      ...
      std::cout<<"finish local vector initialization start rk stepping"<<std::endl;
      for (unsigned int step = 0; step < 4; ++step)
        {
              ...
              if (dem_particles[p_i].integrate_motion)
                {
                  ...
                  std::cout<<"k rk step saved for angular velocity"<<std::endl;
                  ...
                  std::cout<<"k rk step saved for angular position"<<std::endl;
          ...
          std::cout<<"finish this rk step start contact state integration "<<std::endl;
