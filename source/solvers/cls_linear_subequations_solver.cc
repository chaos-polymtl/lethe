...
template <int dim>
void
CLSLinearSubequationsSolver<dim>::setup_dofs()
{
...
template <int dim>
void
CLSLinearSubequationsSolver<dim>::solve_linear_system_and_update_solution()
{
  auto mpi_communicator = this->triangulation->get_mpi_communicator();
...
template <int dim>
void
CLSLinearSubequationsSolver<dim>::solve()
{
...
template class CLSLinearSubequationsSolver<2>;
template class CLSLinearSubequationsSolver<3>;
