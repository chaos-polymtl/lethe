...
template <int dim>
void
GLSNavierStokesCLSAssemblerCore<dim>::assemble_matrix(
  ...
  for (unsigned int q = 0; q < n_q_points; ++q)
    {
      ...
      // From hessian, calculate grad (div (u)) term needed for CLS problems
...
template class GLSNavierStokesCLSAssemblerCore<2>;
template class GLSNavierStokesCLSAssemblerCore<3>;


template <int dim>
void
GLSNavierStokesCLSAssemblerBDF<dim>::assemble_matrix(
  const NavierStokesScratchData<dim>   &scratch_data,
  StabilizedMethodsTensorCopyData<dim> &copy_data)
{
  // Loop and quadrature information
...
template <int dim>
void
GLSNavierStokesCLSAssemblerBDF<dim>::assemble_rhs(
  const NavierStokesScratchData<dim>   &scratch_data,
  StabilizedMethodsTensorCopyData<dim> &copy_data)
{
  // Loop and quadrature information
...
template class GLSNavierStokesCLSAssemblerBDF<2>;
template class GLSNavierStokesCLSAssemblerBDF<3>;


template <int dim>
void
PhaseChangeDarcyCLSAssembler<dim>::assemble_matrix(
  const NavierStokesScratchData<dim>   &scratch_data,
  StabilizedMethodsTensorCopyData<dim> &copy_data)
{
  // Loop and quadrature information
...
template <int dim>
void
PhaseChangeDarcyCLSAssembler<dim>::assemble_rhs(
  const NavierStokesScratchData<dim>   &scratch_data,
  StabilizedMethodsTensorCopyData<dim> &copy_data)
{
  // Loop and quadrature information
...
template class PhaseChangeDarcyCLSAssembler<2>;
template class PhaseChangeDarcyCLSAssembler<3>;
...
template <int dim>
void
GLSNavierStokesCLSAssemblerSTF<dim>::assemble_rhs(
  const NavierStokesScratchData<dim>   &scratch_data,
  StabilizedMethodsTensorCopyData<dim> &copy_data)
{
  // Loop and quadrature information
...
template class GLSNavierStokesCLSAssemblerSTF<2>;
template class GLSNavierStokesCLSAssemblerSTF<3>;


template <int dim>
void
GLSNavierStokesCLSAssemblerMarangoni<dim>::assemble_matrix(
  const NavierStokesScratchData<dim> & /*scratch_data*/,
  StabilizedMethodsTensorCopyData<dim> & /*copy_data*/)
{}
...
template <int dim>
void
GLSNavierStokesCLSAssemblerMarangoni<dim>::assemble_rhs(
  const NavierStokesScratchData<dim>   &scratch_data,
  StabilizedMethodsTensorCopyData<dim> &copy_data)
{
  // Densities of phases
...
template class GLSNavierStokesCLSAssemblerMarangoni<2>;
template class GLSNavierStokesCLSAssemblerMarangoni<3>;


template <int dim>
void
NavierStokesCLSAssemblerEvaporation<dim>::assemble_matrix(
  const NavierStokesScratchData<dim> & /*scratch_data*/,
  StabilizedMethodsTensorCopyData<dim> & /*copy_data*/)
{}
...
template <int dim>
void
NavierStokesCLSAssemblerEvaporation<dim>::assemble_rhs(
  const NavierStokesScratchData<dim>   &scratch_data,
  StabilizedMethodsTensorCopyData<dim> &copy_data)
{
  // Loop and quadrature information
...
template class NavierStokesCLSAssemblerEvaporation<2>;
template class NavierStokesCLSAssemblerEvaporation<3>;


template <int dim>
void
GLSNavierStokesCLSAssemblerNonNewtonianCore<dim>::assemble_matrix(
  const NavierStokesScratchData<dim>   &scratch_data,
  StabilizedMethodsTensorCopyData<dim> &copy_data)
{
  const std::vector<double> &viscosity_for_stabilization_vector =
...
template <int dim>
void
GLSNavierStokesCLSAssemblerNonNewtonianCore<dim>::assemble_rhs(
  const NavierStokesScratchData<dim>   &scratch_data,
  StabilizedMethodsTensorCopyData<dim> &copy_data)
{
  const std::vector<double> &viscosity_for_stabilization_vector =
...
template class GLSNavierStokesCLSAssemblerNonNewtonianCore<2>;
template class GLSNavierStokesCLSAssemblerNonNewtonianCore<3>;

template <int dim>
void
ThermalBuoyancyAssemblyCLS<dim>::assemble_matrix(
  const NavierStokesScratchData<dim> & /*scratch_data*/,
  StabilizedMethodsTensorCopyData<dim> & /*copy_data*/)
{}
...
template <int dim>
void
ThermalBuoyancyAssemblyCLS<dim>::assemble_rhs(
  const NavierStokesScratchData<dim>   &scratch_data,
  StabilizedMethodsTensorCopyData<dim> &copy_data)
{
  // Loop and quadrature information
...
template class ThermalBuoyancyAssemblyCLS<2>;
template class ThermalBuoyancyAssemblyCLS<3>;
