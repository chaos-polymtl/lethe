...
{
  if (geometric_redistanciation_parameters.transformation_type == Parameters::RedistanciationTransformationType::piecewise_polynomial)
      return std::make_shared<SignedDistanceTransformationPiecewisePolynomial>(geometric_redistanciation_parameters.max_reinitialization_distance);
  else
