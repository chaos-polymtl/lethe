...
template <int dim>
void
PSPGSUPGRANSTurbulenceAssemblerCore<dim>::assemble_matrix(
  ...
  StabilizedMethodsTensorCopyData<dim> &copy_data)
{
  ...
  // Turbulent viscosity
  const std::vector<double> &turbulent_viscosity_vector =
    scratch_data.turbulent_viscosity;
...
template <int dim>
void
PSPGSUPGRANSTurbulenceAssemblerCore<dim>::assemble_rhs(
  const NavierStokesScratchData<dim>   &scratch_data,
  StabilizedMethodsTensorCopyData<dim> &copy_data)
{
  // Scheme and physical properties
...
template class PSPGSUPGRANSTurbulenceAssemblerCore<2>;
template class PSPGSUPGRANSTurbulenceAssemblerCore<3>;


template <int dim>
void
PSPGSUPGRANSTurbulenceAssemblerBDF<dim>::assemble_matrix(
  const NavierStokesScratchData<dim>   &scratch_data,
  StabilizedMethodsTensorCopyData<dim> &copy_data)
{
  // Loop and quadrature information
...
template <int dim>
void
PSPGSUPGRANSTurbulenceAssemblerBDF<dim>::assemble_rhs(
  const NavierStokesScratchData<dim>   &scratch_data,
  StabilizedMethodsTensorCopyData<dim> &copy_data)
{
  // Loop and quadrature information
...
template class PSPGSUPGRANSTurbulenceAssemblerBDF<2>;
template class PSPGSUPGRANSTurbulenceAssemblerBDF<3>;
