...
void
VOFCurvatureProjection<dim, ScratchDataType>::assemble_local_system_matrix(
...
template <int dim, typename ScratchDataType>
void
VOFCurvatureProjection<dim, ScratchDataType>::assemble_local_system_rhs(
  const typename DoFHandler<dim>::active_cell_iterator &cell,
  ScratchDataType                                      &scratch_data,
  StabilizedMethodsCopyData                            &copy_data)
{
...
template class VOFCurvatureProjection<2, VOFCurvatureProjectionScratchData<2>>;
template class VOFCurvatureProjection<3, VOFCurvatureProjectionScratchData<3>>;
