...
//           const auto grad_phi_u_i_x_velocity_ale = grad_phi_u_i *
//           velocity_ale; const auto strong_residual_ale_x_grad_phi_u_i =
...
//               local_matrix(i, j) += tau * (strong_jac_ale * grad_phi_p_i) *
//               JxW;
