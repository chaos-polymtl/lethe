  ...
  StabilizedMethodsCopyData    &copy_data)
{
  ...
  template <int dim>
  void HeatTransferAssemblerBDF<dim>::assemble_matrix(
    HeatTransferScratchData<dim> & scratch_data,
    StabilizedMethodsCopyData & copy_data)
  {
    // Loop and quadrature information
  ...
  template <int dim>
  void HeatTransferAssemblerBDF<dim>::assemble_rhs(
    HeatTransferScratchData<dim> & scratch_data,
    StabilizedMethodsCopyData & copy_data)
  {
    // Gather physical properties in case of mono fluids simulations (to be
        ...
        for (unsigned int i = 0; i < n_dofs; ++i)
          {
            ...
            for (unsigned int p = 0;
              ...
              {
                local_rhs_i -=
                  rho_cp * bdf_coefs[p] * (temperature[p] * phi_T_i);
  ...
  template <int dim>
  void HeatTransferAssemblerRobinBC<dim>::assemble_matrix(
    HeatTransferScratchData<dim> & scratch_data,
    StabilizedMethodsCopyData & copy_data)
  {
    ...
    for (unsigned int i_bc = 0; i_bc < this->boundary_conditions_ht.size;
         ++i_bc)
      {
        if (this->boundary_conditions_ht.type[i_bc] ==
            BoundaryConditions::BoundaryType::convection_radiation)
          {
            ...
            const double emissivity =
              this->boundary_conditions_ht.emissivity[i_bc]->value(
                Point<dim>());
                        ...
                        for (unsigned int i = 0; i < scratch_data.n_dofs; ++i)
                          {
                            ...
                            for (unsigned int j = 0; j < scratch_data.n_dofs;
                                 ++j)
                              {
  ...
  template <int dim>
  void HeatTransferAssemblerRobinBC<dim>::assemble_rhs(
    HeatTransferScratchData<dim> & scratch_data,
    StabilizedMethodsCopyData & copy_data)
  {
    if (!scratch_data.is_boundary_cell)
  ...
  template <int dim>
  void HeatTransferAssemblerViscousDissipation<dim>::assemble_matrix(
    HeatTransferScratchData<dim> & /*scratch_data*/, StabilizedMethodsCopyData &
    /*copy_data*/)
  {}

  template <int dim>
  void HeatTransferAssemblerViscousDissipation<dim>::assemble_rhs(
    HeatTransferScratchData<dim> & scratch_data,
    StabilizedMethodsCopyData & copy_data)
  {
    const unsigned int n_q_points = scratch_data.n_q_points;
  ...
  template <int dim>
  void HeatTransferAssemblerViscousDissipationVOF<dim>::assemble_matrix(
    HeatTransferScratchData<dim> & /*scratch_data*/, StabilizedMethodsCopyData &
    /*copy_data*/)
  {}

  template <int dim>
  void HeatTransferAssemblerViscousDissipationVOF<dim>::assemble_rhs(
    HeatTransferScratchData<dim> & scratch_data,
    StabilizedMethodsCopyData & copy_data)
  {
    const unsigned int n_q_points = scratch_data.n_q_points;
        ...
        if (this->viscous_dissipative_fluid ==
        ...
        else
          {
            throw(std::runtime_error(
              "Invalid viscous dissipative fluid. "
  ...
  template <int dim>
  void HeatTransferAssemblerLaserExponentialDecay<dim>::assemble_matrix(
    HeatTransferScratchData<dim> & /*scratch_data*/,
    StabilizedMethodsCopyData & /*copy_data*/)
  {}

  template <int dim>
  void HeatTransferAssemblerLaserExponentialDecay<dim>::assemble_rhs(
    HeatTransferScratchData<dim> & scratch_data,
    StabilizedMethodsCopyData & copy_data)
  {
    // Laser parameters
  ...
  template <int dim>
  void HeatTransferAssemblerLaserExponentialDecayVOF<dim>::assemble_matrix(
    HeatTransferScratchData<dim> & /*scratch_data*/,
    StabilizedMethodsCopyData & /*copy_data*/)
  {}

  template <int dim>
  void HeatTransferAssemblerLaserExponentialDecayVOF<dim>::assemble_rhs(
    HeatTransferScratchData<dim> & scratch_data,
    StabilizedMethodsCopyData & copy_data)
  {
    // Laser parameters
  ...
  template <int dim>
  void HeatTransferAssemblerLaserUniformHeatFluxVOFInterface<dim>::assemble_rhs(
    HeatTransferScratchData<dim> & scratch_data,
    StabilizedMethodsCopyData & copy_data)
  {
    // Laser parameters
        ...
        for (unsigned int q = 0; q < n_q_points; ++q)
          {
            ...
            if (laser_location_on_surface.distance(
                  quadrature_point_on_surface) < beam_radius)
              {
  ...
  template <int dim>
  void HeatTransferAssemblerFreeSurfaceRadiationVOF<dim>::assemble_matrix(
    HeatTransferScratchData<dim> & scratch_data,
    StabilizedMethodsCopyData & copy_data)
  {
    // Loop and quadrature information
  ...
  template <int dim>
  void HeatTransferAssemblerFreeSurfaceRadiationVOF<dim>::assemble_rhs(
    HeatTransferScratchData<dim> & scratch_data,
    StabilizedMethodsCopyData & copy_data)
  {
    // Loop and quadrature information
  ...
  template <int dim>
  void HeatTransferAssemblerVOFEvaporation<dim>::assemble_matrix(
    HeatTransferScratchData<dim> & scratch_data,
    StabilizedMethodsCopyData & copy_data)
  {
  ...
  template <int dim>
  void HeatTransferAssemblerVOFEvaporation<dim>::assemble_rhs(
    HeatTransferScratchData<dim> & scratch_data,
    StabilizedMethodsCopyData & copy_data)
  {
    // Loop and quadrature informations
