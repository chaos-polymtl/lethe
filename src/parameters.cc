...
void Forces::declare_parameters(ParameterHandler &prm) {
  prm.enter_subsection("forces");
  {
    ...
    prm.declare_entry("display precision", "4", Patterns::Integer(),
                      "Output frequency");
...
void Mesh::declare_parameters(ParameterHandler &prm) {
  ...
  {
    prm.declare_entry("type", "gmsh", Patterns::Selection("gmsh|primitive"),
                      "Type of mesh "
    ...
    prm.declare_entry("hs inner radius", "1", Patterns::Double(),
                      "Inner radius for hyper shell");

    prm.declare_entry("hs outer radius", "2", Patterns::Double(),
                      "Outer radius for hyper shell");

    prm.declare_entry("hc left", "0", Patterns::Double(),
                      "Left position of hyper cube");

    prm.declare_entry("hc right", "1", Patterns::Double(),
                      "Right position of hyper cube");

    prm.declare_entry("colorize", "false", Patterns::Bool(),
...
void LinearSolver::declare_parameters(ParameterHandler &prm) {
  prm.enter_subsection("linear solver");
  {
    ...
    prm.declare_entry(
        "method", "gmres", Patterns::Selection("gmres|bicgstab|amg"),
...
void MeshAdaptation::declare_parameters(ParameterHandler &prm) {
  prm.enter_subsection("mesh adaptation");
  {
    ...
    prm.declare_entry("min refinement level", "1", Patterns::Integer(),
