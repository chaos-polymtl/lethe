...
/**
 * @brief This code tests the CLS subequations interface.
 */
...
test()
{
  ...
  // For CLS, since the number of fluids must be set to 2, but
  ...
  // Construct CLS subequations interface object
  CLSSubequationsInterface<dim> subequations_interface(solver_parameters,
                                                       pcout,
                                                       tria,
                                                       simulation_control);
