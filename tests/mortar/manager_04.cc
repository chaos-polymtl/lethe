 ...
 * read mesh and manifolds, and computing number of faces at the rotor-stator interface
...
deallog << "Faces at rotor-stator interface : " << n_subdivisions << std::endl;
      ...
      for (unsigned int i = 0; i < n_subdivisions; ++i)
        {
          ...
          for (unsigned int i = 0; i < indices.size(); ++i)
            {
              deallog << indices[i] << ": " << weights[i] << "   " << points [i][0] << "   " << points[i][1] << "   " << normals[i][0] << "   " << normals[i][1]  << std::endl;
            }
          deallog << std::endl;
        }
      deallog << std::endl;
