...
We get the following torques and forces applied on the particle for each of the mesh refinements. The drag force applied on the particle is the effective force in the same direction as the flow, which is in the :math:`x` direction in this case.
